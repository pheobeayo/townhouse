    ...
    <footer className="h-20">
      <figure className="relative transition-all duration-300 cursor-pointer filter grayscale hover:grayscale-0 w-full">
        ...
        <figcaption className="absolute bottom-40 grid place-items-center mx-80 ">
          <h1 className="text-white font-semibold text-6xl text-center leading-tight">
          ...
          <div className="">
            ...
            focus:outline-none focus:border-[var(--primary-01)] bg-transparent text-white"
                  placeholder="Your Email Address Here"
                />
                <button className="px-2 sm:px-4 py-2 bg-[var(--primary-01)] hover:bg-[var(--primary-02)] text-white rounded-r-md focus:outline-none">
                  Submit
                </button>
              </div>
            </form>
