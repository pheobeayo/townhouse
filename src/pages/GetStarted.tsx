...
function GetStarted() {
    ...
    return (
        <main style={{background:`${screenBackground}`,backgroundPosition:'center',backgroundSize:'contain'}} className={`flex h-screen justify-center max-md:flex-col max-md:items-center `}>
            {showLogo?(
